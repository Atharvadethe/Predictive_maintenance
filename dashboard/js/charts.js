...
const CHARTS = (() => {
    ...
    Chart.defaults.color = themeVar('--muted', '#5A6E8A');
    Chart.defaults.borderColor = themeVar('--border', '#D8DFE8');
    Chart.defaults.font.family = themeVar('--font-sans', "'DM Sans', sans-serif");
    Chart.defaults.font.size = 11;
    Chart.defaults.layout = { padding: { left: 12, right: 12, top: 4, bottom: 4 } };
    Chart.defaults.plugins.legend.labels.color = themeVar('--muted', '#5A6E8A');
    Chart.defaults.plugins.legend.labels.usePointStyle = true;
    Chart.defaults.plugins.legend.labels.pointStyleWidth = 10;
    Chart.defaults.plugins.legend.labels.padding = 16;
    Chart.defaults.plugins.tooltip.backgroundColor = themeVar('--white', '#FFFFFF');
    Chart.defaults.plugins.tooltip.titleColor = themeVar('--ink', '#001A3A');
    Chart.defaults.plugins.tooltip.bodyColor = themeVar('--body', '#1D3050');
    Chart.defaults.plugins.tooltip.titleFont = { size: 12, weight: '600' };
    Chart.defaults.plugins.tooltip.bodyFont = { size: 11 };
    Chart.defaults.plugins.tooltip.padding = 10;
    Chart.defaults.plugins.tooltip.cornerRadius = 5;
    Chart.defaults.plugins.tooltip.borderColor = themeVar('--border-md', '#B8C4D4');
    ...
    const COLORS = {
        ...
        pink:     '#69B3E7',
        navy:     '#002D62',
        blueBg:   'rgba(0,102,204,0.12)',
        greenBg:  'rgba(0,135,90,0.12)',
        amberBg:  'rgba(180,83,9,0.12)',
        redBg:    'rgba(217,45,32,0.12)',
        purpleBg: 'rgba(105,65,198,0.12)',
    };
