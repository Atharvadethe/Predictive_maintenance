...
function renderAnomalyPage() {
    ...
    content.innerHTML = `
        ...
        <div class="grid mb-4 stagger" id="anomalyKpis" style="grid-template-columns:repeat(7,minmax(0,1fr));gap:var(--sp-3)">
            ...
            <div class="kpi-card blue">
                <div class="kpi-top">
                    ...
                    <div class="card-icon" style="background:var(--blue-bg);color:var(--blue)"><i class="fas fa-link"></i></div>
                </div>
            ...
            <div class="kpi-card green">
                <div class="kpi-top">
                    ...
                    <div class="card-icon" style="background:var(--green-bg);color:var(--green)"><i class="fas fa-clipboard-list"></i></div>
                </div>
            ...
            <div class="kpi-card amber">
                <div class="kpi-top">
                    ...
                    <div class="card-icon" style="background:var(--amber-bg);color:var(--amber)"><i class="fas fa-wave-square"></i></div>
                </div>
        ...
        <div class="grid grid-3 mb-4">
            ...
            <div class="card" style="grid-column:span 2">
                ...
                <div class="alert-feed anomaly-feed">
                    ${alertsSorted.map(a => `
                        <div class="alert-item anomaly-alert" data-alert-id="${a.id}" style="${!a.acknowledged ? 'border-left:3px solid ' + (a.level === 'Critical' ? 'var(--red)' : 'var(--amber)') : ''}">
                            ...
                            <div style="display:flex;flex-direction:column;gap:6px;align-items:flex-end">
                                ${a.workOrderId ? `<button class="badge badge-amber anomaly-wo-chip" style="font-size:9px" onclick="openWorkOrderPanel('${a.id}')"><i class="fas fa-clipboard-list"></i> ${a.workOrderId}</button>` : ''}
                                ${a.acknowledged
                                ...
                                ${a.workOrderId ? '' : `<button class="btn btn-sm btn-primary" onclick="openWorkOrderPanel('${a.id}')"><i class="fas fa-clipboard-list"></i> WO</button>`}
                            </div>
                        </div>
                    `).join('')}
                </div>
            ...
            <div class="card">
                ...
                <div class="timeline anomaly-timeline">
        ...
        <div class="grid grid-1 mb-4 anomaly-band">
            <!-- Threshold Breach Analysis -->
            <div class="card anomaly-distribution-card">
                <div class="card-header">
                    <span class="card-title">Alert Distribution by Sensor Type</span>
                </div>
                <div class="chart-container anomaly-chart" style="height:220px">
